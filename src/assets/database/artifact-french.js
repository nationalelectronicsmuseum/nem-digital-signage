const data = [
    ...
    info: [
      {
        ...
        description:
          "La radioamateur (Ham Radio) est un passe-temps international sur des fréquences désignées permettant la communication via diverses méthodes, par ex. Code Morse, voix et données. Les indicatifs d'appel tels que K3NEM (notre indicatif d'appel de station) sont uniques à chaque jambon ou club sous licence. Les préfixes des indicatifs d'appel varient selon les pays.",
      },
      {
        id: 2,
        name: "QUI PEUT ÊTRE OPÉRATEUR DE RADIO AMATEUR (HAM) ?",
        description:
          "Aux États-Unis, les personnes de tout âge peuvent passer les examens. Les licences sont délivrées par chaque pays et sont accordées selon des degrés de privilège. La maîtrise du code Morse n'est plus requise. Si vous savez manier un téléphone portable, vous êtes sur la bonne voie pour devenir un jambon !",
      },
      {
        id: 3,
        name: "QUE PUIS-JE FAIRE DANS HAM RADIO ?",
        description:
          "Beaucoup communiquent par voie hertzienne avec des radioamateurs locaux et lointains en utilisant la voix, le code Morse, les signaux numériques ou même la télévision bidirectionnelle. La communication dans les situations d’urgence est une activité civique populaire et importante. On peut apprendre à construire, réparer et comprendre des appareils électroniques (opportunités de carrière)",
      },
      {
        id: 4,
        name: "COMMUNICATIONS D'URGENCE",
        description:
          "Lorsque les systèmes téléphoniques sont en panne, la radioamateur continue de passer. Les radioamateurs travaillent avec des agences gouvernementales pour les communications. Nous transmettons des datagrammes de trafic, comme les messages Western Union, via des réseaux de radioamateurs en direct. La photo est celle de l'ARRL Field Day, un événement annuel de préparation aux situations d'urgence.",
      },
      {
        id: 5,
  ...
  {
    tag: 1,
    stationTitle: "Tension et courant",
    slideTitle: "Tension et courant",
    info: [
      {
        id: 1,
        text: "",
    ...
    impact:
      "Comprendre la tension et le courant aide les ingénieurs et les scientifiques à concevoir des systèmes électriques plus sûrs et plus efficaces. Des plus petits circuits aux plus grands réseaux électriques, ces concepts sont cruciaux pour créer une technologie qui fonctionne de manière fiable et sûre.",
    directions: {
  ...
  },
  {
    ...
    slideTitle: "Le détecteur magnétique Marconi",
    info: [
      {
        id: 1,
        title: "Inventeur:",
  ...
  },
  {
    ...
    impact:
      "La découverte d'Oersted a été la clé qui a révélé la mystérieuse relation entre l'électricité et le magnétisme. Cette révélation a jeté les bases du développement des moteurs électriques, des générateurs et de la technologie moderne sur laquelle nous comptons aujourd’hui.",
    directions: {
      title: "Comment ça marche :",
      steps: [
        {
  ...
  },
  {
    ...
    impact:
      "Nous pouvons créer de l'électricité par action chimique. En fermant les circuits, nous permettons à cette énergie de circuler. Vous avez fourni le fluide conducteur pour cette batterie, l’électricité circule donc à travers vous !",
    directions: {
      title: "Essayez ceci :",
      steps: [
        {
  ...
  },
  {
    ...
    slideTitle:
      "Expérience de l'échelle de Jacob : démonstration des principes électriques",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    stationTitle: "Expérience de polarisation",
    slideTitle: "Expérience de polarisation",
    info: [
      {
        id: 1,
        text: "",
    ...
    impact:
      "La polarisation est ce qui permet au grillage de la porte de votre four à micro-ondes d'empêcher l'énergie dangereuse de s'échapper. Les fils du treillis bloquent les ondes verticales et horizontales se déplaçant dans les deux sens.",
    directions: {
      title: "Comment ça marche ?",
      steps: [
        {
  ...
  },
  {
    ...
    impact:
      "Les aliments dans le four absorbent l'énergie des micro-ondes. Le plateau tournant fait tourner les aliments selon les intensités de champ élevées et faibles. Le résultat est une cuisson minutieuse.",
    directions: {
      title: "Comment ça marche ?",
      steps: [
        {
    ...
    telegraphStation: {
      ...
      instructions: [
        ...
        },
        {
          id: 2,
          steps:
            "Maintenez puis relâchez pour les tirets, appuyez et relâchez rapidement pour les points.",
        },
        {
          id: 3,
  ...
  {
    stationTitle: "Première diffusion",
    slideTitle: "Première diffusion",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    stationTitle: "Turbine manuelle",
    slideTitle: "Turbine manuelle",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    stationTitle: "Ondes radio électromagnétiques",
    slideTitle: "Ondes radio électromagnétiques",
    info: [
      {
        id: 1,
        title: "Nom:",
  ...
  {
    stationTitle: "Tube à vide",
    slideTitle: "Tube à vide",
    info: [
      {
        id: 1,
        text: "",
  ...
  },
  {
    ...
    slideTitle:
      "Le générateur Van de Graaff : exploiter la puissance de l’électricité statique",
    info: [
      {
        id: 1,
        title: "Nom:",
      ...
      list: [
        {
          ...
          item: "La Ceinture.",
          description:
            "À l’intérieur de la machine se trouve une courroie en caoutchouc ou en tissu qui se déplace en continu sur des rouleaux. Lorsque la courroie se déplace, elle frotte contre les rouleaux, captant de minuscules charges électriques grâce à un processus appelé friction.",
        },
        {
          id: 2,
          item: "Le Peigne.",
          description:
            "Lorsque la courroie se déplace, elle passe devant un peigne (une bande métallique dotée de pointes acérées) près de la base de la machine. Le peigne transfère les charges électriques de la courroie vers le dôme métallique situé au sommet du générateur.",
        },
        {
          id: 3,
          item: "Le Dôme.",
          description:
            "Le dôme est comme un conteneur géant pour les charges électriques. À mesure que les charges s'accumulent, le dôme devient très chargé. Il s’agit d’électricité statique, semblable à ce qui se produit lorsque vous frottez un ballon sur vos cheveux.",
        },
        {
          id: 4,
  ...
  {
    stationTitle: "Traducteur audio",
    slideTitle: "Le traducteur audio",
    info: [
      {
        id: 1,
        title: "Impact:",
  ...
  },
  {
    ...
    description: ["Ceci est un exemple de texte.", "Ceci est également un exemple de texte."],
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        ...
        recordedOn:
          "Enregistré sur un magnétophone portable Sony TC 2850SD sur cassettes Memorex.",
      },
    ],
  },
  {
  ...
  {
    tag: 28,
    stationTitle: "Histoire des tubes à vide",
    slideTitle: "Histoire des tubes à vide",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 29,
    stationTitle: "Types de tubes à vide",
    slideTitle: "Types de tubes à vide",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 30,
    stationTitle: "Comment fonctionnent les tubes à vide ?",
    slideTitle: "Comment fonctionnent les tubes à vide",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 34,
    stationTitle: "Sons en mer",
    slideTitle: "Sons en mer",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 35,
    stationTitle: "Balise sonar",
    slideTitle: "Balise sonar",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 36,
    stationTitle: "Bouées sonar",
    slideTitle: "Bouées sonar",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 38,
    stationTitle: "Mers vétérans",
    slideTitle: "Mers vétérans",
    info: [
      {
        id: 1,
        text: "",
