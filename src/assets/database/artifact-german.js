const artifact = [
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        id: 4,
        title: "Auswirkungen:",
        text: "Grundlage für moderne drahtlose Technologie"
      }
    ],
    description: [
    ...
    impact:
      "Der Marconi Magnetic Detektor ist ein kritischer Baustein, der die Reise zur globalen Konnektivität begann. Diese Erfindung hat das Kommunikationsspiel verändert und unsere moderne Welt gestaltet. Diese Entdeckung legte die Grundlage für zukünftige drahtlose Innovationen wie Radios, Fernseher, Internet, Smartphones und Wi-Fi.",
    timeline: {
      title: "Geschichte der drahtlosen Kommunikation",

      dates: [
        { id: 1, date: "1890er Jahre", text: "Erste drahtlose Kommunikation" },

        { id: 2, date: "1900er Jahre", text: "Erste Radiosendung" },

        { id: 3, date: "1920er Jahre", text: "Erster kommerzieller Radio" },

        {
          id: 4,
          date: "1930 S.", text: "Radartechnologie, Fernsehsendungen",
        },

        { id: 5, date: "1940er Jahre", text: "Qualitätsfunkdienste" },

        { id: 6, date: "1950er Jahre", text: "Erste Satelliten, das Weltraumprogramm" },

        { id: 7, date: "1970er Jahre", text: "Mobilfunknetze, GPS" },

        { id: 8, date: "1980er Jahre", text: "Mobilfunknetze der ersten Generation" },

        {
          id: 9,
          date: "1990 S.", text: "Mobilfunknetze der zweiten Generation, Wi-Fi",
        },

        { id: 10, date: "2000er Jahre", text: "Satelliten -Internet, 3G -Netzwerke" },

        { id: 11, date: "2010er", text: "LTE Advanced, 5G -Netzwerk" },
      ],
    },
    directions: {
      title: "Wie es funktioniert",
      steps: [
        { id: 1, step: "Hören Sie den Telefonempfänger an." },
        {
          id: 2,
        ...
        {
          id: 4,
          step: "Sehen Sie, wie langsam Sie den Knopf drehen und trotzdem das Radio hören können.",
        },
      ],
    },
    watch: "",
...

  {
    ...
    impact:
      "Faradays Experiment war ein entscheidender Schritt, um die Beziehung zwischen Elektrizität und Magnetismus zu verstehen. Dieser Durchbruch führte zur Entwicklung von Generatoren, die den Strom produzieren, der unsere Häuser, Schulen und Geräte versorgt. Ohne Faradays Entdeckungen gibt es viele der elektronischen Geräte, auf die wir uns heute verlassen, nicht.",
    directions: {
...

  {
    ...
    impact:
      "Oersteds Entdeckung war der Schlüssel, der die mysteriöse Beziehung zwischen Elektrizität und Magnetismus aufschaltete. Diese Offenbarung legte den Grundstein für die Entwicklung von Elektromotoren, Generatoren und der modernen Technologie, auf die wir uns heute verlassen.",
    directions: {
      title: "Wie es funktioniert",
      steps: [
        {
...

  {
    ...
    impact:
      "Wir können durch chemische Wirkung Strom erzeugen. Durch Schließen von Schaltkreisen lassen wir diese Energie fließen. Sie haben die leitende Flüssigkeit für diese Batterie bereitgestellt, sodass der Strom durch Sie fließt!",
    directions: {
      title: "Versuchen Sie das:",
      steps: [
        {
          id: 1,
          step: "Legen Sie eine Hand auf jeden Teller",
        },
        {
          id: 2,
...

  {
    ...
    impact:
      "Polarisation ist das, was den Netzbildschirm in Ihrer Mikrowellenofen -Türblock -gefährliche Energie durch Flucht ermöglicht. Die Drähte des Netzes sind vertikale und horizontale Blockierungswellen in beide Richtungen.",
    directions: {
      title: "Wie funktioniert es?",
      steps: [
        {
...

  {
    ...
    impact:
      "Die Nahrung im Ofen absorbiert Mikrowellenenergie. Der Plattenspieler dreht die Nahrung durch die hohen und niedrigen Feldintensitäten. Gründliches Kochen ist das Ergebnis.",
    directions: {
      title: "Wie funktioniert es?",
      steps: [
        {
...

  {
    ...
    info: [
      ...
      },
      {
        id: 2,
        title: "Erfinder:",
        text: "Samuel Morse und Alfred Vail",
      },
      {
        id: 3,
        title: "Jahr der Erfindung:",
      ...
      },
      {
        id: 5,
        title: "Sprache:",
        text: "Morsecode (Punkte und Striche)",
      },
      {
        id: 6,
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        id: 4,
        title: "Typ:",
        text: "Elektronisches Musikinstrument",
      },
      {
        id: 5,
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        id: 2,
        title: "Entdeckt:",
        text: "Im späten 19. Jahrhundert von Heinrich Hertz",
      },
      {
        id: 3,
      ...
      },
      {
        id: 4,
        title: "Auswirkungen:",
        text: "Revolutionierte Kommunikation, ermöglichte drahtlose Technologien",
      },
    ],
    description: [
  ...
  },
  {
    ...
    description: ["Dieses Experiment zeigt, wie Filter elektromagnetische Wellen ermöglichen, die in eine bestimmte Richtung durchlaufen, während sie andere blockieren, und die Auswirkungen der Polarisation auf elektromagnetische Wellen zeigt.  Mit polarisierter Sonnenbrille erzeugt der Filter vertikale Öffnungen für Licht. Nur Lichtstrahlen, die sich Ihren Augen vertikal nähern, können durch diese Öffnungen passen. Die Linsen blockieren alle horizontalen Lichtwellen, die zum Beispiel von einem glatten Teich oder einer glänzenden Autohaube abprallen.  Dies ist ein ähnliches Konzept wie die Polarisation auf elektromagnetischen Wellen.", "", "", ""],
    ...
    watch: "Schauen Sie sich die Messgeräte an, um zu sehen, wie viel elektromagnetische Energie übertragen wird und wie viel empfangen wird. Änderen sich die Beträge, wenn sich das Bildschirmrad bewegt?",
  ...
  {
    title:
      "Der Van de Graaff Generator: Nutzung der Leistung von statischer Elektrizität",
    info: [
      {
        id: 1,
        title: "Name:",
    ...
    impact:
      "Dieser Generator hilft Wissenschaftlern, die Kräfte zu verstehen, die Atome zusammenhalten.  Es wurde einst in Laboratorien verwendet, um Partikel für Experimente in der Kernphysik zu beschleunigen und uns zu helfen, mehr über das Universum und die Bausteine ​​der Materie zu erfahren. Höhere Energy -Maschinen - 1937 baute die Westinghouse Electric Company eine 65 -Fuß -Maschine, die Westinghouse Atom Smasher, die in Forest Hills, Pennsylvania 5 MeV, 5 MeV erzeugen kann.  Es war der Beginn der nuklearen Forschung für zivile Anwendungen.  Es wurde 1958 stillgelegt und 2015 teilweise abgerissen.",
    directions: {
      title: "Wie funktioniert es?",
      steps: [
        {
      ...
      list: [
        {
          ...
          item: "Der Gürtel.",
          description:
            "In der Maschine befindet sich ein Gummi oder einen Stoffriemen, der sich ständig über Walzen bewegt. Während sich der Gürtel bewegt, reibt er sich gegen die Walzen und erfasst winzige elektrische Ladungen durch einen Prozess, der als Reibung bezeichnet wird.",
        },
        {
          id: 2,
          item: "Der Kamm.",
          description:
            "Wenn sich der Gürtel bewegt, verläuft er an einem Kamm (einem Metallstreifen mit scharfen Punkten) in der Nähe der Maschine. Der Kamm überträgt die elektrischen Ladungen vom Gürtel an die Metallkuppel oben am Generator.",
        },
        {
          id: 3,
          item: "Die Kuppel.",
          description:
            "Die Kuppel ist wie ein riesiger Behälter für elektrische Gebühren. Während sich die Gebühren aufbauen, wird die Kuppel hoch aufgeladen. Dies ist statischer Strom, ähnlich wie beim Reiben eines Ballons an Ihrem Haar.",
        },
        {
          id: 4,
          item: "Funken und statisch.",
          description:
            "Wenn sich die Gebühren auf der Kuppel genug aufbauen, suchen sie nach einem Weg zum Flucht.  Wenn Sie ein Metallobjekt (oder sogar Ihre Hand) in der Nähe der Kuppel bringen, springen die Ladungen durch die Luft und erzeugen einen sichtbaren Funken.  Manchmal, wenn Sie die Kuppel berühren, bewegen sich die Ladungen durch Sie - und tragen Sie Ihr Haar zu Ende.",
        },
      ],
    },
    try: {
  ...
  },
  {
    ...
    directions: {
      ...
      steps: [
        ...
        {
          id: 2,
          step: "Wenn Sie die grüne Linie auf dem Bildschirm sehen, sprechen Sie in die Löcher an der Vorderseite des Gehäuses.",
        },
        {
          id: 3,
          step: "Beobachten Sie, wie die grüne Linie auf dem Bildschirm auf den Klang Ihrer Stimme reagiert. Es wandelt Schall in ein elektrisches Signal um.",
        },
      ],
    },
