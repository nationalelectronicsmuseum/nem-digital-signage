...
export const FONT_SANS_DYSLEX = "OpenDyslexicMono";

export const FONT_SIZE_SMALL = "24pt";
export const FONT_SIZE_MEDIUM = "35pt";
export const FONT_SIZE_LARGE = "45pt";

export const LIST_PADDING_SMALL = "36px";
export const LIST_PADDING_MEDIUM = "50px";
export const LIST_PADDING_LARGE = "65px";