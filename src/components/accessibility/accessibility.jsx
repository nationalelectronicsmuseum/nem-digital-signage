        ...
        <div className="qp">
          ...
          <span className="qpChild">
            ...
            <span className="btnLng">
              <button
                className={
                  settings.language === Constant.LANGUAGE_ENGLISH
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectEng}
              ...
              <button
                className={
                  settings.language === Constant.LANGUAGE_SPANISH
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectSpa}
              ...
              <button
                className={
                  settings.language === Constant.LANGUAGE_GERMAN
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectGer}
              ...
              <button
                className={
                  settings.language === Constant.LANGUAGE_FRENCH
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectFre}
              ...
              <button
                className={
                  settings.language === Constant.LANGUAGE_CHINESE
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectChi}
              ...
              <button
                className={
                  settings.language === Constant.LANGUAGE_JAPANESE
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={selectJap}
          ...
          <span className="qpChild">
            ...
            <span>
              <button
                className={
                  settings.font === Constant.FONT_SANS
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontArial}
              ...
              <button
                className={
                  settings.font === Constant.FONT_SERIF
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontTimes}
              ...
              <button
                className={
                  settings.font === Constant.FONT_SANS_DYSLEX
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontDyslex}
          ...
          <span className="qpChild">
            ...
            <span>
              <button
                className={
                  settings.fontSize === Constant.FONT_SIZE_SMALL
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontSm}
              ...
              <button
                className={
                  settings.fontSize === Constant.FONT_SIZE_MEDIUM
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontDef}
              ...
              <button
                className={
                  settings.fontSize === Constant.FONT_SIZE_LARGE
                    ? "qpBtn colorSelected"
                    : "qpBtn"
                }
                onClick={fontLg}
          ...
          <span className="qpChild">
            ...
            <span>
              <button
                className={
                  settings.speechEnabled ? "qpBtn colorSelected" : "qpBtn"
                }
                onClick={audioControlOn}
              >
                On
              </button>
              <button
