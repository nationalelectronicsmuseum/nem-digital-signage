...
const SlidesAudio = () => {
  const evolutionOfRecordedSound = getLocalizedArtifact(
    EVOLUTION_OF_RECORDED_SOUND
  );
  ...
  return (
    <div>
      ...
      >
        <AudioSlide
          info={evolutionOfRecordedSound.info[0]}
          image={audioImg1}
          audio={audio1}
        />
        <AudioSlide
          info={evolutionOfRecordedSound.info[1]}
          image={audioImg2}
          audio={audio2}
        />
        <AudioSlide
          info={evolutionOfRecordedSound.info[2]}
          image={audioImg3}
          audio={audio3}
        />
      </Swiper>
