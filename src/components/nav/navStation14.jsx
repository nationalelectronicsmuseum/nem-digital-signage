...
import {
  WHAT_ARE_COUNTERMEASURES,
  CHAFF,
  DECOYS,
  TYPES_OF_COUNTERMEASURES,
  COUNTERMEASURE_BIOGRAPHY,
...
const NavStation14 = () => {
  ...
  const countermeasureBiography = getLocalizedArtifact(
    COUNTERMEASURE_BIOGRAPHY
  );
