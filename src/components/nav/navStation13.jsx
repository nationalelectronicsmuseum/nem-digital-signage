  ...
  return (
    <div>
      <div className="nav menu">
        ...
        <Link to="/whatIsDoppler" relative="path" className="nav-links" onClick={cancelSpeech}>
        {whatIsDoppler.stationTitle}
        </Link>
        <Link to="/dopplerHistory" relative="path" className="nav-links" onClick={cancelSpeech}>
        {dopplerHistory.stationTitle}
        </Link>
        <Link to="/bomarc" relative="path" className="nav-links" onClick={cancelSpeech}>
        {bomarc.stationTitle}
        </Link>
        <Link to="/modernDopplerUse" relative="path" className="nav-links" onClick={cancelSpeech}>
        {modernDopplerUse.stationTitle}
        </Link>
        <Link to="/dopplerOralHistory" relative="path" className="nav-links" onClick={cancelSpeech}>
