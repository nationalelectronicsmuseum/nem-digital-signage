const data = [
    ...
    info: [
      {
        ...
        description:
          "Amateurfunk (Ham Radio) ist ein internationales Hobby auf bestimmten Frequenzen, das die Kommunikation über verschiedene Methoden ermöglicht, z.B. Morsecode, Sprache und Daten. Rufzeichen wie K3NEM (unser Stationsrufzeichen) sind für jeden lizenzierten Funkamateur oder Verein einzigartig. Rufzeichenpräfixe variieren je nach Land.",
      },
      {
        id: 2,
      ...
      dates: [
        {
          id: 1,
          date: "1890er Jahre",
          text: "Erste drahtlose Kommunikation",
        },
        {
          id: 2,
          date: "1900er Jahre",
          text: "Erste Radiosendung",
        },
        {
          id: 3,
          date: "1920er Jahre",
        ...
        },
        {
          id: 7,
          date: "1970er Jahre",
          text: "Mobilfunknetze, GPS",
        },
        {
          id: 8,
          date: "1980er Jahre",
          text: "Mobilfunknetze der ersten Generation",
        },
        {
          id: 9,
          date: "1990er Jahre",
  ...
  },
  {
    ...
    impact:
      "Oersteds Entdeckung war der Schlüssel zur geheimnisvollen Beziehung zwischen Elektrizität und Magnetismus. Diese Offenbarung legte den Grundstein für die Entwicklung von Elektromotoren, Generatoren und der modernen Technologie, auf die wir heute angewiesen sind.",
    directions: {
      title: "So funktioniert es:",
      steps: [
        {
  ...
  },
  {
    ...
    impact:
      "Wir können durch chemische Einwirkung Elektrizität erzeugen. Indem wir Kreisläufe schließen, lassen wir diese Energie fließen. Sie haben die leitende Flüssigkeit für diese Batterie bereitgestellt, sodass der Strom durch Sie fließt!",
    directions: {
      title: "Versuchen Sie Folgendes:",
      steps: [
        {
  ...
  },
  {
    ...
    slideTitle:
      "Jakobsleiter-Experiment: Demonstration elektrischer Prinzipien",
    info: [
      {
        id: 1,
        text: "",
  ...
  },
  {
    ...
    impact:
      "Durch die Polarisation verhindert das Maschensieb in der Tür Ihres Mikrowellenofens, dass gefährliche Energie entweicht. Die Drähte des Netzes sind vertikale und horizontale Sperrwellen, die sich in beide Richtungen bewegen.",
    directions: {
      title: "Wie funktioniert es?",
      steps: [
        {
  ...
  },
  {
    ...
    impact:
      "Lebensmittel im Ofen absorbieren Mikrowellenenergie. Der Drehteller dreht Lebensmittel durch die hohe und niedrige Feldintensität. Gründliches Garen ist das Ergebnis.",
    directions: {
      title: "Wie funktioniert es?",
      steps: [
        {
    ...
    telegraphStation: {
      ...
      instructions: [
        ...
        },
        {
          id: 2,
          steps:
            "Für Striche gedrückt halten und dann loslassen, für Punkte kurz drücken und loslassen.",
        },
        {
          id: 3,
  ...
  },
  {
    ...
    slideTitle:
      "Der Van de Graaff-Generator: Die Kraft statischer Elektrizität nutzen",
    info: [
      {
        id: 1,
        title: "Name:",
      ...
      list: [
        {
          ...
          item: "Der Gürtel.",
          description:
            "Im Inneren der Maschine befindet sich ein Gummi- oder Stoffband, das sich kontinuierlich über Rollen bewegt. Während sich das Band bewegt, reibt es an den Rollen und nimmt durch einen Prozess namens Reibung winzige elektrische Ladungen auf.",
        },
        {
          id: 2,
          item: "Der Kamm.",
          description:
            "Während sich das Band bewegt, passiert es einen Kamm (einen Metallstreifen mit scharfen Spitzen) in der Nähe der Maschinenbasis. Der Kamm überträgt die elektrischen Ladungen vom Gürtel auf die Metallkuppel oben am Generator.",
        },
        {
          id: 3,
          item: "Die Kuppel.",
          description:
            "Die Kuppel ist wie ein riesiger Behälter für elektrische Ladungen. Wenn sich die Ladungen aufbauen, wird die Kuppel stark aufgeladen. Dabei handelt es sich um statische Elektrizität, ähnlich wie wenn man einen Luftballon über sein Haar reibt.",
        },
        {
          id: 4,
          item: "Funken und statische Aufladung.",
          description:
            "Wenn sich die Ladungen auf der Kuppel stark genug aufbauen, suchen sie nach einem Fluchtweg.  Wenn Sie einen Metallgegenstand (oder sogar Ihre Hand) in die Nähe der Kuppel bringen, springen die Ladungen durch die Luft und erzeugen einen sichtbaren Funken.  Manchmal, wenn Sie die Kuppel berühren, bewegen sich die Ladungen durch Sie hindurch, sodass Ihnen die Haare zu Berge stehen.",
        },
      ],
    },
    try: {
  ...
  },
  {
    ...
    description: ["Dies ist ein Beispieltext.", "Dies ist auch ein Beispieltext."],
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        ...
        recordedOn:
          "Aufgenommen mit dem tragbaren Kassettenrecorder Sony TC 2850SD auf Memorex-Kassetten.",
      },
    ],
  },
  {
  ...
  {
    tag: 28,
    stationTitle: "Geschichte der Vakuumröhre",
    slideTitle: "Geschichte der Vakuumröhre",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 29,
    stationTitle: "Vakuumröhrentypen",
    slideTitle: "Vakuumröhrentypen",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 30,
    stationTitle: "Wie funktionieren Vakuumröhren?",
    slideTitle: "Wie Vakuumröhren funktionieren",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 39,
    stationTitle: "Was ist Radar?",
    slideTitle: "Was ist Radar?",
    info: [
      {
        id: 1,
        text: "",
  ...
  {
    tag: 40,
    stationTitle: "Arten von Radar",
    slideTitle: "Arten von Radar",
    info: [
      {
        id: 1,
        text: "",
